/*
 * All Admin Related Scripts in this Dotus Theme
...
"use strict";
  ...
  /*---------------------------------------------------------------*/
   function dotus_gutenberg_toggle_metaboxes() {
  ...
  function dotus_toggle_metaboxes() {
  ...
  $(document).ready(function() {
      dotus_gutenberg_toggle_metaboxes();
      dotus_toggle_metaboxes();
    $('#post-formats-select input[type="radio"]').on('click', dotus_toggle_metaboxes);
  });
