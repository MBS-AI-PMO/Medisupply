 ...
 */
	...
	// Theme Options
	$dotus_single_comment = cs_get_option( 'single_comment_form' );
...
?>
<div class="wpo-blog-single-section section-padding <?php echo esc_attr( $dotus_content_padding .' '. $dotus_sidebar_class ); ?>" style="<?php echo esc_attr( $dotus_custom_padding ); ?>">
