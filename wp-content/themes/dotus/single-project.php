...
get_header();
	...
	// Theme Options
	$dotus_sidebar_position = cs_get_option( 'project_sidebar_position' );
	$dotus_single_comment = cs_get_option( 'project_comment_form' );
	$dotus_sidebar_position = $dotus_sidebar_position ? $dotus_sidebar_position : 'sidebar-hide';
	// Sidebar Position
	if ( $dotus_sidebar_position === 'sidebar-hide' ) {
		$dotus_layout_class = 'col-lg-10 offset-lg-1';
		$dotus_sidebar_class = 'hide-sidebar';
	} elseif ( $dotus_sidebar_position === 'sidebar-left' ) {
		$dotus_layout_class = 'col col-lg-8 order-lg-2';
		$dotus_sidebar_class = 'left-sidebar';
	} else {
		$dotus_layout_class = 'col col-lg-8';
		$dotus_sidebar_class = 'right-sidebar';
	} ?>
<div class="project-single-section section-padding <?php echo esc_attr( $dotus_content_padding .' '. $dotus_sidebar_class ); ?>" style="<?php echo esc_attr( $dotus_custom_padding ); ?>">
	<div class="container">
		<div class="row">
