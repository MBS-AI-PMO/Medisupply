<?php
/**
 * Class Name: dotus_wp_bootstrap_navwalker
...
class dotus_wp_bootstrap_navwalker extends Walker_Nav_Menu {
	...
	public static function fallback( $args ) {
		if ( current_user_can( 'manage_options' ) ) {
			...
			$fb_output .= '>';
			$fb_output .= '<li><a href="' . admin_url( 'nav-menus.php' ) . '">'.esc_html__( 'Add a menu','dotus' ).'</a></li>';
			$fb_output .= '</ul>';
