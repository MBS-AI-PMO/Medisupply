...
if ( ! function_exists( 'dotus_widget_init' ) ) {
	function dotus_widget_init() {
		if ( function_exists( 'register_sidebar' ) ) {

			// Main Widget Area
			register_sidebar(
				array(
					'name' => esc_html__( 'Main Widget Area', 'dotus' ),
					'id' => 'sidebar-1',
					'description' => esc_html__( 'Appears on posts and pages.', 'dotus' ),
	    ...
	    if( $footer_widgets ) {
	      ...
	      for( $i = 0; $i < $length; $i++ ) {
	        ...
	        register_sidebar( array(
	          'id'            => 'footer-' . $num,
	          'name'          => esc_html__( 'Footer Widget ', 'dotus' ). $num,
	          'description'   => esc_html__( 'Appears on footer section.', 'dotus' ),
	...
	add_action( 'widgets_init', 'dotus_widget_init' );
}