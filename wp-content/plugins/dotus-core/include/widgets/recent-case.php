 ...
 */
class dotus_causes_posts extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      '-causes-blog',
      DOTUS_THEME_NAME_PLUGIN . esc_html__( ': Causes Posts', 'dotus' ),
      array(
        'classname'   => 'recent-post-widget',
        'description' => DOTUS_THEME_NAME_PLUGIN . esc_html__( ' widget that displays causes posts.', 'dotus' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $instance   = wp_parse_args( $instance, array(
      'title'    => esc_html__( 'Causes Posts', 'dotus' ),
      'ptypes'   => 'post',
      'limit'    => '3',
      'date'     => true,
      'category' => '',
  ...
  public function widget( $args, $instance ) {
    ...
    if ($dotus_rpw->have_posts()) : while ($dotus_rpw->have_posts()) : $dotus_rpw->the_post();
      ...
      if (!empty( $post_img )) {
        ...
        $post_img = DOTUS_PLUGIN_IMGS.'/70X80.jpg';
      } ?>
    <div class="post">
...
add_action( 'widgets_init', function() { register_widget( "dotus_causes_posts" ); } );