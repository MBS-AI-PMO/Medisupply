 ...
 */
class dotus_footer_posts extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      '-footer-blog',
      DOTUS_THEME_NAME_PLUGIN . esc_html__( ': Footer Posts', 'dotus' ),
      array(
        'classname'   => 'footer-post-widget',
        'description' => DOTUS_THEME_NAME_PLUGIN . esc_html__( ' widget that displays footer posts.', 'dotus' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $instance   = wp_parse_args( $instance, array(
      'title'    => esc_html__( 'Footer Posts', 'dotus' ),
      'ptypes'   => 'post',
      'limit'    => '3',
      'date'     => true,
      'category' => '',
...
add_action( 'widgets_init', function() { register_widget( "dotus_footer_posts" ); } );