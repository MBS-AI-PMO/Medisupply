 ...
 */
class dotus_text_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      'text-widget',
      DOTUS_THEME_NAME_PLUGIN . esc_html__( ': Text Widget', 'dotus' ),
      array(
        'classname'   => 'text-widget',
        'description' => DOTUS_THEME_NAME_PLUGIN . esc_html__( ' widget that displays contents.', 'dotus' )
      )
    );
  }
...
add_action( 'widgets_init', function() { register_widget( "dotus_text_widget" ); } );