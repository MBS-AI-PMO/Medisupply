...
class dotus_navigation_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      '-navigation-widget',
      DOTUS_THEME_NAME_PLUGIN . esc_html__( ': Navigation', 'dotus' ),
      array(
        'classname'   => 'link-widget',
        'description' => DOTUS_THEME_NAME_PLUGIN . esc_html__( ' widget that displays navigations list.', 'dotus' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $nav_list_field = array(
      ...
      'type' => 'select',
      'options' => 'menus',
      'title' => esc_html__( 'Select Menu List :', 'dotus' ),
    );
    ...
    $nav_child_field = array(
      ...
      'title' => esc_html__( 'Display Menu Children :', 'dotus' ),
      'help' => esc_html__( 'This only shows first level of child menus.', 'dotus' ),
    );
...
add_action( 'widgets_init', function() { register_widget( "dotus_navigation_widget" ); } );
