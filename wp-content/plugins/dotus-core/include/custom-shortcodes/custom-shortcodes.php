<?php
/* Spacer */
function dotus_spacer_function($atts, $content = true) {
...
add_shortcode("dotus_spacer", "dotus_spacer_function");

/* Social Icons */
function dotus_socials_function($atts, $content = true) {
  extract(shortcode_atts(array(
    "social_select" => '',
    "custom_class" => '',
    "section_title" => '',
  ...
  if ( $icon_color || $icon_size ) {
    ...
    $inline_style .= ( $icon_size ) ? 'font-size:'. dotus_core_check_px($icon_size) .';' : '';
    $inline_style .= '}';
  }
...
add_shortcode("dotus_socials", "dotus_socials_function");

/* Social Icon */
function dotus_social_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_link" => '',
      "social_icon" => '',
      "target_tab" => ''
...
add_shortcode("dotus_social", "dotus_social_function");



/* Simple Images */
function dotus_image_lists_function($atts, $content = true) {
  extract(shortcode_atts(array(
    "custom_class" => '',
  ), $atts));
...
add_shortcode("dotus_image_lists", "dotus_image_lists_function");

/* Simple Image */
function dotus_image_list_function($atts, $content = NULL) {
  extract(shortcode_atts(array(
    "get_image" => '',
    "link" => '',
    "open_tab" => ''
...
add_shortcode("dotus_image_list", "dotus_image_list_function");

/* Simple Underline Link */
function dotus_simple_link_function($atts, $content = NULL) {
  extract(shortcode_atts(array(
    "link_style" => '',
    "link_icon" => '',
    "link_text" => '',
  ...
  if ( $text_color || $text_size ) {
    ...
    $inline_style .= ( $text_size ) ? 'font-size:'. dotus_core_check_px($text_size) .';' : '';
    $inline_style .= '}';
  }
  if ( $text_hover_color ) {
...
add_shortcode("dotus_simple_link", "dotus_simple_link_function");


/* Top bar info */
function dotus_widget_topbars_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
   ), $atts));
...
add_shortcode("dotus_widget_topbars", "dotus_widget_topbars_functions");

/* Top bar info */
function dotus_widget_topbar_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "info_icon" => '',
      "subtitle" => '',
      "title" => '',
...
add_shortcode("dotus_widget_topbar", "dotus_widget_topbar_function");


/*header Social */
function dotus_header_socials_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "custom_text" => ''
   ), $atts));
...
add_shortcode("dotus_header_socials", "dotus_header_socials_function");

/* Address Info */
function dotus_header_social_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_icon" => '',
      "social_icon_color" => '',
      "social_link" => '',
...
add_shortcode("dotus_header_social", "dotus_header_social_function");


/*header Middle Info */
function dotus_header_middle_infos_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => ''
   ), $atts));
...
add_shortcode("dotus_header_middle_infos", "dotus_header_middle_infos_function");

/*header Middle Info  */
function dotus_header_middle_info_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_icon" => '',
      "social_icon_color" => '',
      "address_text" => '',
...
add_shortcode("dotus_header_middle_info", "dotus_header_middle_info_function");
/*header Middle Info End */

/* Address Infos */
function dotus_address_infos_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => ''
   ), $atts));
...
add_shortcode("dotus_address_infos", "dotus_address_infos_function");

/* Address Info */
function dotus_address_info_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "address_style" => '',
      "info_icon" => '',
      "info_icon_color" => '',
...
add_shortcode("dotus_address_info", "dotus_address_info_function");

/* Useful Links */
function dotus_useful_links_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "column_width" => '',
      "custom_class" => ''
   ), $atts));
...
add_shortcode("dotus_useful_links", "dotus_useful_links_function");

/* Useful Link */
function dotus_useful_link_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "target_tab" => '',
      "title_link" => '',
      "link_title" => ''
...
add_shortcode("dotus_useful_link", "dotus_useful_link_function");

/* Footer Menus */
function dotus_footer_menus_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => ''
   ), $atts));
...
add_shortcode("dotus_footer_menus", "dotus_footer_menus_function");

/* Footer Menu */
function dotus_footer_menu_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "menu_title" => '',
      "menu_link" => '',
      "target_tab" => ''
...
add_shortcode("dotus_footer_menu", "dotus_footer_menu_function");

/* footer contact */
function dotus_footer_contacts_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "contact_title" => '',
   ), $atts));
...
add_shortcode("dotus_footer_contact_infos", "dotus_footer_contacts_functions");

/*  footer contact  */
function dotus_footer_contacts_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "icon" => '',
      "item_title" => '',
   ), $atts));
...
add_shortcode("dotus_footer_contact_info", "dotus_footer_contacts_function");


 /* footer Address */
function dotus_addresss_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
   ), $atts));
...
add_shortcode("dotus_footer_address_item", "dotus_addresss_functions");


 /* footer Addresss */
function dotus_address_functions($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "item" => '',
   ), $atts));
...
add_shortcode("dotus_footer_address_items", "dotus_address_functions");

/* Blockquote */
function dotus_blockquote_function($atts, $content = true) {
  extract(shortcode_atts(array(
    "blockquote_style" => '',
    "text_size" => '',
    "custom_class" => '',
...
add_shortcode("dotus_blockquote", "dotus_blockquote_function");


/* Footer Logo Items */
function dotus_widget_footer_infos_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "footer_logo" => '',
      "desc" => '',
...
add_shortcode("footer_infos", "dotus_widget_footer_infos_functions");


/* Footer Logo Item */
function dotus_widget_footer_infos_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_icon" => '',
      "social_link" => '',
   ), $atts));
...
add_shortcode("footer_info", "dotus_widget_footer_infos_function");


/* Contact Infos */
function dotus_widget_contact_infos_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "heading_title" => ''
   ), $atts));
...
add_shortcode("dotus_widget_contact_infos", "dotus_widget_contact_infos_functions");


/* Widget Contact Info */
function dotus_widget_contact_infos_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "title" => '',
      "number" => '',
...
add_shortcode("dotus_widget_contact_info", "dotus_widget_contact_infos_function");


/* Widget Contact Info */
function dotus_widget_testimonial_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "title" => '',
      "subtitle" => '',
...
add_shortcode("dotus_widget_testimonial", "dotus_widget_testimonial_function");


/* Service Contact Widgets */
function dotus_service_widget_contacts_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "contact_title" => '',
   ), $atts));
...
add_shortcode("dotus_service_widget_contacts", "dotus_service_widget_contacts_functions");

/* Service Contact Widget */
function dotus_service_widget_contact_functions($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "info" => '',
   ), $atts));
...
add_shortcode("dotus_service_widget_contact", "dotus_service_widget_contact_functions");

/* Download Widgets */
function dotus_download_widgets_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
   ), $atts));
...
add_shortcode("dotus_download_widgets", "dotus_download_widgets_functions");

/* Download Widget */
function dotus_download_widget_functions($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "download_icon" => '',
      "title" => '',
      "link" => '',
...
add_shortcode("dotus_download_widget", "dotus_download_widget_functions");

/* Current Year - Shortcode */
if( ! function_exists( 'dotus_current_year' ) ) {
  function dotus_current_year() {
    return date('Y');
  }
  add_shortcode( 'dotus_current_year', 'dotus_current_year' );
}

/* Get Home Page URL - Via Shortcode */
if( ! function_exists( 'dotus_home_url' ) ) {
  function dotus_home_url() {
    return esc_url( home_url( '/' ) );
  }
  add_shortcode( 'dotus_home_url', 'dotus_home_url' );
}


/* About Widget */
function dotus_widget_about_block_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "title" => '',
      "image_url" => '',
...
add_shortcode("dotus_about_widget", "dotus_widget_about_block_function");