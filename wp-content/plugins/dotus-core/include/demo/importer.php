 ...
 */
function dotus_import_files() {
  return array(
    array(
      'import_file_name'           => 'Dotus',
      'import_file_url'            => trailingslashit( DOTUS_PLUGIN_URL ) . 'include/demo/content.xml',
      'local_import_csf'           => array(
        array(
          'file_path'   => trailingslashit( DOTUS_PLUGIN_URL ) . 'include/demo/theme-options.json',
          'option_name' => '_cs_options',
        ),
      ),
      'import_widget_file_url'     => trailingslashit( DOTUS_PLUGIN_URL ) . 'include/demo/widget.wie',
      'preview_url'                => 'https://wpolive.com/dotus/',
      'import_notice'                => '',
      'import_preview_image_url'   => 'https://wpolive.com/dotus/wp-content/themes/dotus/screenshot.png',
    ),
  );
}
add_filter( 'pt-ocdi/import_files', 'dotus_import_files' );
...
/**
 * dotus_after_import_setup
 * @return Front Page, Post Page & Menu Set
 */
function dotus_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'dotus_after_import_setup' );

$locations = get_theme_mod( 'nav_menu_locations' );


// Install Demos Menu - Menu Edited
function dotus_core_one_click_page( $default_settings ) {
  $default_settings['parent_slug'] = 'themes.php';
  $default_settings['page_title']  = esc_html__( 'Install Demo', 'dotus-core' );
  $default_settings['menu_title']  = esc_html__( 'Install Demo', 'dotus-core' );
  $default_settings['capability']  = 'import';
  $default_settings['menu_slug']   = 'install_demos';

  return $default_settings;
}
add_filter( 'pt-ocdi/plugin_page_setup', 'dotus_core_one_click_page' );

// Model Popup - Width Increased
function dotus_ocdi_confirmation_dialog_options ( $options ) {
...
add_filter( 'pt-ocdi/confirmation_dialog_options', 'dotus_ocdi_confirmation_dialog_options', 10, 1 );


function dotus_ocdi_plugin_intro_text( $default_text ) {
    $default_text .= '
  <h1>Import Demo</h1>
    <div class="dotus-core_intro-text demo-one-click">
      <div id="poststuff" class="postbox-wrap clearfix">
        ...
        <div class="box-inner important-notes">
          ...
          <div class="inside">
            ...
            <a href="https://wpocean.com/docs/dotus/documentation" class="button-primary" target="_blank">Docs</a>
...
add_filter( 'pt-ocdi/plugin_intro_text', 'dotus_ocdi_plugin_intro_text' );