...
class Dotus_brand extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-dotus_brand';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Site Logo', 'dotus-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Dotus brand widget depended on.
	...
	*/
	...
	/**
	 * Register Dotus brand widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_brand',
			[
				'label' => esc_html__( 'Brand Options', 'dotus-core' ),
			]
		);
		$this->add_control(
			'brand_logo',
...
Plugin::instance()->widgets_manager->register( new Dotus_brand() );