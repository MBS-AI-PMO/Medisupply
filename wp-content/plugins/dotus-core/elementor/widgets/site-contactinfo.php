...
class Dotus_Contactinfo extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-dotus_contactinfo';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Contact Info', 'dotus-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Dotus Contactinfo widget depended on.
	...
	*/
	...
	/**
	 * Register Dotus Contactinfo widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_contactinfo',
			[
				'label' => esc_html__( 'Contactinfo Options', 'dotus-core' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( '24/7 customer support.', 'dotus-core' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Contactinfo Icons', 'dotus-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'contactinfo_title' => esc_html__( 'Contactinfo', 'dotus-core' ),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Info Box', 'dotus-core' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Icon BG', 'dotus-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
	...
	// Content
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Active', 'dotus-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'active_border_color',
			[
				'label' => esc_html__( 'Active Border', 'dotus-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'active_color',
			[
				'label' => esc_html__( 'Text Color', 'dotus-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Dotus_Contactinfo() );