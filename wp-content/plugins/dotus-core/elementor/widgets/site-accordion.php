<?php
/*
 * Elementor Dotus Accordion  Widget
...
class Dotus_Accordion  extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-dotus_accordion';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Accordion ', 'dotus-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Dotus Accordion  widget depended on.
	...
	*/
	...
	/**
	 * Register Dotus Accordion  widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_accordion',
			[
				'label' => esc_html__( 'Accordion  Options', 'dotus-core' ),
			]
		);
		...
		$repeater->add_control(
			'active_tabs',
			[
				'label' => __( 'Active Accordion', 'dotus-core' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Accordion  Items', 'dotus-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'accordion_title' => esc_html__( 'Accordion ', 'dotus-core' ),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Accordion Content', 'dotus-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
			...
			[
				'label' => esc_html__( 'Typography', 'dotus-core' ),
				'name' => 'dotus_accordion_content_typography',
...
Plugin::instance()->widgets_manager->register( new Dotus_Accordion () );