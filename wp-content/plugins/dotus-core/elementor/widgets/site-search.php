...
class Dotus_Search extends Widget_Base{
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Dotus Search widget depended on.
	...
	*/
	...
	/**
	 * Register Dotus Search widget controls.
...
Plugin::instance()->widgets_manager->register( new Dotus_Search() );