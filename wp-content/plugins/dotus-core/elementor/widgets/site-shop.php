<?php
/*
 * Elementor Dotus Product Widget
...
class Dotus_Product extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-dotus_product';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Product', 'dotus-core' );
	}
  ...
  public function get_keywords() {
	...
	/**
	 * Retrieve the list of scripts the Dotus Product widget depended on.
	...
	*/
	...
	/**
	 * Register Dotus Product widget controls.
    ...
    if ( $posts ) {
      ...
      $PostID[ __( 'No ID\'s found', 'dotus' ) ] = 0;
		...
		$this->add_control(
			'product_limit',
			[
				'label' => esc_html__( 'Product Limit', 'dotus-core' ),
...
Plugin::instance()->widgets_manager->register( new Dotus_Product() );