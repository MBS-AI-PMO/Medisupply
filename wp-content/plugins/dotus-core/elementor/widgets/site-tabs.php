...
class Dotus_Tabs  extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-dotus_tabs';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Tabs ', 'dotus-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Dotus Tabs  widget depended on.
	...
	*/
	...
	/**
	 * Register Dotus Tabs  widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_tabs',
			[
				'label' => esc_html__( 'Tabs  Options', 'dotus-core' ),
			]
		);
		...
		$repeater->add_control(
			'active_tabs',
			[
				'label' => __( 'Active Tabs', 'dotus-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'dotus-core' ),
				'label_off' => __( 'Hide', 'dotus-core' ),
				'return_value' => 'yes',
				'default' => 'yes',
			]
		);
		...
		$repeater->add_control(
			'tabs_content',
			[
				'label' => esc_html__( 'Content Text', 'dotus-core' ),
				'type' => Controls_Manager::WYSIWYG,
				'default' => esc_html__( 'Content Text', 'dotus-core' ),
				'placeholder' => esc_html__( 'Type content text here', 'dotus-core' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'tabsItems_groups',
			[
				'label' => esc_html__( 'Tabs  Items', 'dotus-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'tabs_title' => esc_html__( 'Tabs ', 'dotus-core' ),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tabs Title', 'dotus-core' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Active Color', 'dotus-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Active Background Color', 'dotus-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tabs Content', 'dotus-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
...
Plugin::instance()->widgets_manager->register( new Dotus_Tabs () );