...
class Dotus_Button extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-dotus_button';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Button', 'dotus-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Dotus Button widget depended on.
	...
	*/
	...
	/**
	 * Register Dotus Button widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_Button',
			[
				'label' => __( 'Button Options', 'dotus-core' ),
			]
		);
		$this->add_control(
			'btn_style',
			[
				'label' => esc_html__( 'Button Style', 'dotus-core' ),
				...
				'default' => 'style-one',
				'description' => esc_html__( 'Select your Button style.', 'dotus-core' ),
			]
		);
		$this->add_responsive_control(
			'section_alignment',
			[
				'label' => esc_html__( 'Alignment', 'dotus-core' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => esc_html__( 'Left', 'dotus-core' ),
						'icon' => 'fa fa-align-left',
					],
					'center' => [
						'title' => esc_html__( 'Center', 'dotus-core' ),
						'icon' => 'fa fa-align-center',
					],
					'right' => [
						'title' => esc_html__( 'Right', 'dotus-core' ),
		...
		$this->start_controls_tabs( 'button_style' );
			...
			$this->add_control(
				'link_border_color',
				[
					'label' => esc_html__( 'Link Border Color', 'dotus-core' ),
					'type' => Controls_Manager::COLOR,
					'selectors' => [
...
Plugin::instance()->widgets_manager->register( new Dotus_Button() );