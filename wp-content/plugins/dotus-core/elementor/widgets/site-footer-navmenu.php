<?php
/*
 * Elementor Dotus FooterNavmenu Widget
...
class Dotus_FooterNavmenu extends Widget_Base{
	...
	*/
	public function get_name(){
		return 'wpo-dotus_footernavmenu';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Footer Menu', 'dotus-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Dotus FooterNavmenu widget depended on.
	...
	*/
	...
	/**
	 * Register Dotus FooterNavmenu widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'FooterNavmenu Options', 'dotus-core' ),
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'dotus_footer_menu_typography',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Dot Color', 'dotus-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
...
Plugin::instance()->widgets_manager->register( new Dotus_FooterNavmenu() );