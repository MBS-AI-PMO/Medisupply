<?php
/*
 * Elementor Dotus Navmenu Widget
...
class Dotus_Navmenu extends Widget_Base{
	...
	*/
	public function get_title(){
		return esc_html__( 'Nav Menu', 'dotus-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Dotus Navmenu widget depended on.
	...
	*/
	...
	/**
	 * Register Dotus Navmenu widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_Navmenu',
			[
				'label' => esc_html__( 'Navmenu Options', 'dotus-core' ),
			]
		);
...
Plugin::instance()->widgets_manager->register( new Dotus_Navmenu() );