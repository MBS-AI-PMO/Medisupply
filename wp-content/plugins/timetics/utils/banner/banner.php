...
class Banner {
    ...
    private function init_banner($content, $instance, $inline_css){
        ...
        $html = '<a target="_blank" ' . $inline_css . ' class="wpmet-jhanda-href" href="' . esc_url( $content->data->banner_link ) . '"><img style="display: block;margin: 0 auto;" src="' . esc_url( $content->data->banner_image ) . '" /></a>';
