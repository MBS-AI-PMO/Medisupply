                ...
                <main class="main-wrapper">
                    ...
                    <script>
                        ...
                        onboard.addEventListener('click', function(event) {
                            ...
                            var nonce = <?php echo wp_json_encode( wp_create_nonce( 'timetics_staff_onboard_skip' ) ); ?>;
                            ...
                            fetch('<?php echo esc_url( admin_url('admin-ajax.php') ); ?>', {
                                ...
                                body: 'action=timetics_staff_onboard_skip&_wpnonce=' + encodeURIComponent(nonce)
                            })
